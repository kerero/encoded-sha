...
}, $ = (r) => [m.prefix, r, m.suffix].filter((e) => e && e.length > 0).join("-"), Y = (r) => {
...
function te(r) {
  const e = r.length;
  e > 0 && (c.groupCollapsed(`During precaching cleanup, ${e} cached request${e === 1 ? " was" : "s were"} deleted.`), ee("Deleted Cache Requests", r), c.groupEnd());
}
function T(r, e) {
  if (e.length !== 0) {
    c.groupCollapsed(r);
...
function re(r, e) {
  ...
  if (t || s) {
    ...
    s > 0 && (n += ` ${s} file${s === 1 ? " is" : "s are"} already cached.`), c.groupCollapsed(n), T("View newly precached URLs.", r), T("View previously precached URLs.", e), c.groupEnd();
  }
}
let R;
function se() {
...
async function ne(r, e) {
  ...
  }, o = e ? e(n) : n, a = se() ? s.body : await s.blob();
...
class le {
  ...
  constructor(e, t) {
    ...
    }), Object.assign(this, t), this.event = t.event, this._strategy = e, this._handlerDeferred = new ae(), this._extendLifetimePromises = [], this._plugins = [...e.plugins], this._pluginStateMap = /* @__PURE__ */ new Map();
  ...
  async cachePut(e, t) {
    ...
    const { cacheName: a, matchOptions: i } = this._strategy, l = await self.caches.open(a), w = this.hasCallback("cacheDidUpdate"), y = w ? await oe(
    ...
    try {
      ...
      if (f instanceof Error)
        throw f.name === "QuotaExceededError" && await ie(), f;
    }
...
b.copyRedirectedCacheableResponsesPlugin = {
  async cacheWillUpdate({ response: r }) {
    return r.redirected ? await ne(r) : r;
  }
};
class ue {
  /**
  ...
  addToCacheList(e) {
    ...
    for (const s of e) {
      ...
      const { cacheKey: n, url: o } = X(s), a = typeof s != "string" && s.revision ? "reload" : "default";
...
This is generally NOT safe. Learn more at https://bit.ly/wb-precache`;
  ...
  install(e) {
    return O(e, async () => {
      ...
      return process.env.NODE_ENV !== "production" && re(s, n), { updatedURLs: s, notUpdatedURLs: n };
    });
  }
  /**
  ...
  activate(e) {
    return O(e, async () => {
      ...
      return process.env.NODE_ENV !== "production" && te(o), { deletedURLs: o };
    });
  }
  /**
...
class E {
  ...
  constructor(e, t, s = q) {
    process.env.NODE_ENV !== "production" && (p.isType(e, "function", {
      ...
      funcName: "constructor",
      paramName: "match"
    }), s && p.isOneOf(s, he, { paramName: "method" })), this.handler = C(t), this.match = e, this.method = s;
  }
  /**
   *
   * @param {workbox-routing-handlerCallback} handler A callback
...
let N;
const fe = () => (N || (N = new pe(), N.addFetchListener(), N.addCacheListener()), N);
function A(r, e, t) {
  let s;
  if (typeof r == "string") {
    const o = new URL(r, location.href);
...
const P = {
  strategyStart: (r, e) => `Using ${r} to respond to '${d(e.url)}'`,
  printFinalResponse: (r) => {
    r && (c.groupCollapsed("View the final response here."), c.log(r || "[No response returned]"), c.groupEnd());
  }
}, Ne = {
  /**
...
class Ee extends V {
  ...
  async _handle(e, t) {
    ...
    t.waitUntil(n);
    let o = await t.cacheMatch(e), a;
    if (o)
      process.env.NODE_ENV !== "production" && s.push(`Found a cached response in the '${this.cacheName}' cache. Will update with the network response in the background.`);
    else {
      process.env.NODE_ENV !== "production" && s.push(`No response found in the '${this.cacheName}' cache. Will wait for the network response.`);
      try {
        o = await n;
      } catch (i) {
        i instanceof Error && (a = i);
    ...
    if (process.env.NODE_ENV !== "production") {
      c.groupCollapsed(P.strategyStart(this.constructor.name, e));
      for (const i of s)
        c.log(i);
      P.printFinalResponse(o), c.groupEnd();
    }
    if (!o)
...
const u = /* @__PURE__ */ location.pathname.split("/").slice(0, -1).join("/"), _e = [
  u + "/_app/immutable/entry/app.7922c00f.js",
  u + "/_app/immutable/chunks/0.31e79ced.js",
  u + "/_app/immutable/chunks/1.ebce087e.js",
  u + "/_app/immutable/chunks/2.0d7ab130.js",
  u + "/_app/immutable/chunks/index.07554069.js",
  u + "/_app/immutable/chunks/index.82de2a7a.js",
  u + "/_app/immutable/chunks/singletons.e4eb3b62.js",
  u + "/_app/immutable/entry/start.37335d15.js",
  u + "/_app/immutable/entry/error.svelte.21106a43.js",
  ...
  u + "/android-chrome-192x192.png",
  u + "/android-chrome-512x512-square.png",
  u + "/android-chrome-512x512.png",
